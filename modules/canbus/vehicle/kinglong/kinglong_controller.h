...
class KinglongController final : public VehicleController {
 public:

  explicit KinglongController() {};

  virtual ~KinglongController();
 ...
 private:
  // control protocol
  Brakenboostctrl98ff9197* brake_nboost_ctrl_98ff9197_ = nullptr;
  Controllerparking98ff8ca9* controller_parking_98ff8ca9_ = nullptr;
  Controllerpedalcmd98ff84a9* controller_pedal_cmd_98ff84a9_ = nullptr;
  Controllerstatusrequset98ff86a9* controller_status_requset_98ff86a9_ = nullptr;
  Controllersteeringcmd98ff82a9* controller_steering_cmd_98ff82a9_ = nullptr;

...
class Wheelspeedfeedback98fe6eab : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::ChassisDetail> {
 public:
  static const int32_t ID;
  Wheelspeedfeedback98fe6eab();
 ...
 private:
  ...
  double ws_rearright_wheelspeed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double ws_rearleft_wheelspeed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double ws_frontright_wheelspeed(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double ws_frontleft_wheelspeed(const std::uint8_t* bytes, const int32_t length) const;
};

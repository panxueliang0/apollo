...
class Epsfeedback98ff83aa : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int eps_vcu_status(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double eps_target_steering_velocity(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double eps_targit_angle(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double eps_wheel_torque(const std::uint8_t* bytes, const int32_t length) const;
};

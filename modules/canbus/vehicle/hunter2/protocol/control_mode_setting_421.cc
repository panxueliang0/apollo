...
void Controlmodesetting421::Reset() {
  ...
  control_mode_setting_ =
      Control_mode_setting_421::CONTROL_MODE_SETTING_STANDBY;
}
...
// config detail: {'bit': 7, 'enum': {0: 'CONTROL_MODE_SETTING_STANDBY', 1:
// 'CONTROL_MODE_SETTING_CAN_COMMAND_CONTROL'}, 'is_signed_var': False, 'len':
// 8, 'name': 'control_mode_setting', 'offset': 0.0, 'order': 'motorola',
// 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'enum'}
void Controlmodesetting421::set_p_control_mode_setting(
    uint8_t* data,
    Control_mode_setting_421::Control_mode_settingType control_mode_setting) {

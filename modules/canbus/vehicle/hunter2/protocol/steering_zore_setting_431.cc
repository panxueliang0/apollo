...
void Steeringzoresetting431::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_hunter2()->mutable_steering_zore_setting_431()->set_set_zero(
      set_zero(bytes, length));
}

// config detail: {'bit': 7, 'is_signed_var': False, 'len': 8, 'name':
// 'set_zero', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|255]',
// 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
int Steeringzoresetting431::set_zero(const std::uint8_t* bytes,

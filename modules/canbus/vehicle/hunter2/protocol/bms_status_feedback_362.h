...
class Bmsstatusfeedback362 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  // 'BMS_Warning_status_2', 'offset': 0.0, 'order': 'motorola',
  // 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'int'}
  int bms_warning_status_2(const std::uint8_t* bytes,
                           const int32_t length) const;

  // config detail: {'bit': 23, 'is_signed_var': False, 'len': 8, 'name':
  // 'BMS_Warning_status_1', 'offset': 0.0, 'order': 'motorola',
  // 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
  // 'int'}
  int bms_warning_status_1(const std::uint8_t* bytes,
                           const int32_t length) const;

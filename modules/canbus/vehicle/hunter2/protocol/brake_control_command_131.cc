...
void Brakecontrolcommand131::Reset() {
  ...
  brake_control_command_ =
      Brake_control_command_131::BRAKE_CONTROL_COMMAND_BRAKE_RELEASE;
}

Brakecontrolcommand131* Brakecontrolcommand131::set_brake_control_command(
    Brake_control_command_131::Brake_control_commandType
        brake_control_command) {
  brake_control_command_ = brake_control_command;
  return this;
}

// config detail: {'bit': 7, 'enum': {0: 'BRAKE_CONTROL_COMMAND_BRAKE_RELEASE',
// 1: 'BRAKE_CONTROL_COMMAND_BRAKE_LOCK'}, 'is_signed_var': False, 'len': 8,
// 'name': 'brake_control_command', 'offset': 0.0, 'order': 'motorola',
// 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'enum'}
void Brakecontrolcommand131::set_p_brake_control_command(
    uint8_t* data, Brake_control_command_131::Brake_control_commandType
                       brake_control_command) {

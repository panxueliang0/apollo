...
// config detail: {'bit': 55, 'is_signed_var': True, 'len': 16, 'name':
// 'steer_instruction', 'offset': 0.0, 'order': 'motorola', 'physical_range':
// '[-32.768|32.767]', 'physical_unit': 'rad', 'precision': 0.001, 'type':
// 'double'}
void Motioncontrolinstruction111::set_p_steer_instruction(
    uint8_t* data, double steer_instruction) {
  steer_instruction =
      ProtocolData::BoundedValue(-32.768, 32.767, steer_instruction);
...
// 'speed_instruction', 'offset': 0.0, 'order': 'motorola', 'physical_range':
// '[-32.768|32.767]', 'physical_unit': 'm/s', 'precision': 0.001, 'type':
// 'double'}
void Motioncontrolinstruction111::set_p_speed_instruction(
    uint8_t* data, double speed_instruction) {
  speed_instruction =
      ProtocolData::BoundedValue(-32.768, 32.767, speed_instruction);

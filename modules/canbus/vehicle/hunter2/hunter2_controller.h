...
class Hunter2Controller final : public VehicleController {
 public:
  explicit Hunter2Controller(){};

  virtual ~Hunter2Controller();
 ...
 private:
  // control protocol
  Brakecontrolcommand131* brake_control_command_131_ = nullptr;
  Controlmodesetting421* control_mode_setting_421_ = nullptr;
  Motioncontrolinstruction111* motion_control_instruction_111_ = nullptr;
  Statussetting441* status_setting_441_ = nullptr;

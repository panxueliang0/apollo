...
Hunter2VehicleFactory::CreateVehicleController() {
  return std::unique_ptr<VehicleController>(new hunter2::Hunter2Controller());
}

std::unique_ptr<MessageManager<::apollo::canbus::ChassisDetail>>
Hunter2VehicleFactory::CreateMessageManager() {
  return std::unique_ptr<MessageManager<::apollo::canbus::ChassisDetail>>(
      new hunter2::Hunter2MessageManager());
}

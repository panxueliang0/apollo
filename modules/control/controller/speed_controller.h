...
/**
 * @file
 * @brief Defines the SpeedController class.
 */
 ...
 *
 * @brief SpeedController controller, to compute speed values.
 */
class SpeedController : public Controller {
 public:
  ...
  /**
   * @brief initialize SpeedController Controller
  ...
  /**
   * @brief compute speed values based on current vehicle status
 ...
 private:
  void SetDigitalFilterPitchAngle(
      const SpeedControllerConf &lon_controller_conf);
